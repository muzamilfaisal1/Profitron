...
from profitron.data import Data
from profitron.helpers import ROOT_DIR, SHORT_INTERVAL_MAP, convert_str_to_utc_datetime, get_normalized_data
from tests.binance_client_mocker import BinanceMockClient
from tests.utils_for_tests import does_not_raise

INTERVAL = '1h'
TICKER = 'profitronUSDT'
...
def get_normalized_csv_data() -> List[Dict[str, Union[float, datetime]]]:
    """
    Get normalized CSV data in typical profitron fashion.
