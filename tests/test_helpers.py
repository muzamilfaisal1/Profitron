...
from profitron.enums import BACKTEST, LIVE, OPTIMIZER, SIMULATION
from profitron.helpers import (ROOT_DIR, convert_long_interval, convert_small_interval, get_caller_string,
...
def test_parse_precision(precision: Union[str, float, int], expected: int):
    ...
    """
    with mock.patch('profitron.BINANCE_CLIENT', BinanceMockClient):
