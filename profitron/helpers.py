...
import profitron
from profitron.typing_hints import DictType
...
def is_debug() -> bool:
    """
    Returns a boolean whether profitron is running in debug mode or not.
...
def parse_precision(precision: str, symbol: str) -> int:
    ...
    """
    if precision == "Auto":
        symbol_info = profitron.BINANCE_CLIENT.get_symbol_info(symbol)
