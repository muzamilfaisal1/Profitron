"""
Various utility functions for profitron state.
"""
...
from profitron.graph_helpers import set_color_to_label
from profitron.interface.config_utils.slot_utils import delete_strategy_slots, load_custom_strategy_slots
        ...
        try:
            ...
            if config_obj.parent:
                config_obj.parent.add_to_live_activity_monitor('Failed to fully load previous state because of a '
                                                               'potential new update/install. Try restarting profitron.')
