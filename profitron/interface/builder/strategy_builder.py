...
from profitron.enums import TRENDS
from profitron.helpers import STRATEGIES_DIR
from profitron.interface.builder.indicator_selector import IndicatorSelector
from profitron.interface.utils import create_popup, get_widget_with_layout
...
class StrategyBuilder(QDialog):
    ...
    def __init__(self, parent: Optional['Interface'] = None):
        ...
        :param parent: Parent that initializes the strategy builder. (This should be the profitron GUI).
        """
