...
from profitron.interface.configuration_helpers import get_h_line
from profitron.interface.utils import (OPERATORS, PARAMETER_MAP, confirm_message_box, get_bold_font, get_param_obj,
...
if TYPE_CHECKING:
    ...
    from profitron.interface.builder.strategy_builder import StrategyBuilder
...
class IndicatorSelector(QDialog):
    ...
    def update_indicator(self):
        ...
        Update indicator being shown based on the indicator combobox. This will update the info layout with the
         ...
         in the actual profitron interface, not here. This is to have support for dynamic strategies; that is, we don't
    ...
    def add_param_items(self, indicator_info: Dict[str, Any]):
        ...
        #  the user fills them in. Note that profitron will automatically populate the strategy UI elements from just the
        #  strategy name.
        self.state = {
